    ...
    if (lang === "pt") {
      return [
        ...
        },
        {
          ...
          desc: "Venda direta das camisas, copos e moletons oficiais da marca MetalZone ou taxas de intermediação de canecas, patches e broches de metal para parceiros no Brasil.",
      ...
      return [
        ...
        },
        {
          ...
          desc: "Cobro directo de mercancía oficial de MetalZone o productos coleccionables de edición limitada con envíos garantizados.",
      ...
      return [
        ...
        },
        {
          ...
          desc: "Direct retail sales of MetalZone classic street tees, hoods, and steel wristbands integrated with live checkouts.",
    ...
    <div id="monetize-section-wrapper" className="space-y-6">
      ...
      <div className="p-5 bg-neutral-950 border border-neutral-850 rounded-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="shrink-0">
          <a
            href="https://wa.me/5531973267529?text=Patrício, quero patrocinar o MetalZone!"
